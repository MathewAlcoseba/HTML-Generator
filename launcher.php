...
$generator->createDoctype()
    ...
    ->addTag((new HTMLTagBuilder('p'))->withContent('This is another paragraph')->build())
    ...
    ->addTag((new HTMLTagBuilder('p'))->withContent('Sample input fields!')->build())
    ->addTag((new HTMLTagBuilder('br'))->build())
    ->addTag((new HTMLTagBuilder('input'))
    ->withAttribute('type', 'text')
    ->withAttribute('name', 'textfieldone')
    ->withAttribute('id', 'textfield_id')
    ->build())
    ->addTag((new HTMLTagBuilder('br'))->build())
    ->addTag((new HTMLTagBuilder('input'))
    ->withAttribute('type', 'password')
    ->withAttribute('name', 'passwordfieldOne')
    ->withAttribute('id', 'passwordfield_id')
    ->build())
